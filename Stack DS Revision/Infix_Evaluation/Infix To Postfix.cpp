...
// Q->2-:  Convert infix to postfix and return the ans. 

// same code as infix to prefix conversion but change the order of the solve() fun. 
// previous order -> oper,val1,val2
// current order -> val1,val2,oper
...
string solve(string val1, string val2, char ch){
    ...
    // postfix is -: val1, val2, oper -> order changed ************ IMP *************
    string s="";
    s+=val1;
    s+=val2;
    s.push_back(ch);
